...
PHASE_1A_WEIGHTS: dict[str, float] = {
    ...
    "stable_standing": 5.0,
    "torso_upright": 5.0,
    "torso_backward_lean_penalty": 0.0,
...
PHASE_1B_WEIGHTS: dict[str, float] = {
    "foot_ball_distance": 80.0,
    "robot_facing_ball": 4.0,
    "next_kick_foot_height": 15.0,
    "kick": 80.0,
    ...
    "torso_upright": 15.0,
    "torso_backward_lean_penalty": -50.0,
    "leg_action_rate_penalty": -0.5,
    "robot_upright": 12.0,
...
def phase1a_to_1b_curriculum(
    ...
    alternated_kick_ema_threshold: float = 0.001,
    per_foot_kick_ema_threshold: float = 0.001,
    foot_balance_threshold: float = 0.001,
